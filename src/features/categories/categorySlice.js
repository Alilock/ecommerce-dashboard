...
export const fetchAllCategories = createAsyncThunk("categories/getAPI", async () => {
    const response = await axios.get("https://newramana.azurewebsites.net/api/category")

    return response.data.data;
});

export const saveNewCategory = createAsyncThunk("categories/postApi", async (payload) => {
    const response = await axios.post("https://newramana.azurewebsites.net/api/category", payload)
